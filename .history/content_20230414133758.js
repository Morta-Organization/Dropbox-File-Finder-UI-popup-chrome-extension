        ...
        if (!foundFiles) {
          ...
          results.forEach((item, i) => {
            ...
            linkIcon.addEventListener("click", async (e) => {
              // Construct the URL for the Dropbox folder using its ID
              const folderUrl = `https://www.dropbox.com/${item.metadata.id}`;

              // Open the folder URL in a new tab using the Chrome Extension API
