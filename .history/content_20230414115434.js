...
const dropboxClientid = "DBXFF-gsw6a2m0r2u44lt"; //hd: gsw6a2m0r2u44lt //me: lqp7zeiwcl5toer
...
function createUI() {
  ...
  getFilesBtn.className = "DBXFF-button button1 getFIles";
  ...
  floatingElement.className = "DBXFF-box-layout slide-in-left";
      ...
      if (results.length === 0 && inc >= 3) {
        ...
        if (!foundFiles) {
          ...
          results.forEach((item, i) => {
            ...
            const lastIndex =
              item.metadata.metadata.path_display.lastIndexOf("/");
            const folderPath = item.metadata.metadata.path_display.substring(
              0,
              lastIndex
            );
